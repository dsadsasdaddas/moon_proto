...
- Python `google.protobuf` 与 Go `google.golang.org/protobuf` oracle fixtures，用于验证 scalar/repeated/map/oneof/32-bit numeric/float/double golden bytes/JSON 与成熟生态一致；
