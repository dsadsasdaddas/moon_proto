...
- `.proto` lexer/parser：syntax、点分 package、import、option、reserved/extensions、message、enum、optional/repeated、map、oneof、字段/枚举值 options、标量字段和点分 named type；
