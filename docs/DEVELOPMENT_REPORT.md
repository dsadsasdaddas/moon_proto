...
- official differential harness：`python3 scripts/moon_proto_official_diff.py --report generated/official_diff_report.md --junit-out generated/official_diff_report.xml`，并在 CI 中克隆 `moonbitlang/protoc-gen-mbt` 校验官方源码/文档契约；
...
- registry adapter：`python3 scripts/moon_proto_descriptor.py publish generated/descriptor_registry.json --store generated/schema_registry_store --base-dir .` 与 `python3 scripts/moon_proto_descriptor.py pull generated/schema_registry_store/registries/demo-user.json --output-dir generated/schema_registry_pull`，支持本地路径、`file://` 和 HTTP(S) manifest/artifact 拉取，支持 `--bearer-token` / `--token-env` / `--header` 认证，并校验 descriptor SHA-256；
