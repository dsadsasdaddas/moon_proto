...
│   └── file-based generator, Schema Doctor, compatibility checks, AI verify, official differential, descriptor reports, registry manifests, policy reports and registry adapter publish/pull
├── tests/oracle/
...
- Schema Doctor、AI verify report、official differential report、descriptor verify/compat/registry/policy report and JUnit XML 与 CI 官方源码契约检查通过；
