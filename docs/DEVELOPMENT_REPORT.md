...
- conformance-lite evidence report：`python3 scripts/moon_proto_conformance.py --report generated/conformance_lite_report.md --json-out generated/conformance_lite.json --junit-out generated/conformance_lite.xml`，把 oracle-backed fixtures 汇总为 Markdown/JSON/JUnit 验收证据。
...
- Schema Doctor、AI verify report、official differential report、conformance-lite evidence report、descriptor verify/compat/registry/policy report and JUnit XML 与 CI 官方源码契约检查通过；
