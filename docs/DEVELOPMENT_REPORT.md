...
- protobuf-style JSON writer/parser，覆盖 bytes base64、64-bit integer string form、repeated/map/nested/oneof、`null`-as-absent 解析语义与 lowerCamelCase 字段名输入/输出 helper；
