...
- Schema Doctor、AI verify report、official differential report、installed-plugin official generator smoke report、conformance-lite evidence report（含 expected-fail mutation self-checks 与 coverage gates）、descriptor verify/compat/registry/policy report and JUnit XML 与 CI 官方源码契约检查通过；
