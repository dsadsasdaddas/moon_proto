...
- official differential harness：`python3 scripts/moon_proto_official_diff.py --report generated/official_diff_report.md`；
...
├── scripts/moon_proto_gen.py / scripts/moon_proto_lab.py / scripts/moon_proto_official_diff.py
│   └── file-based generator, Schema Doctor, compatibility checks, AI verify and official differential reports
├── tests/oracle/
...
- Schema Doctor、AI verify report 与 official differential report 检查通过；
...
- 在安装 `protoc` 与官方 checkout 的环境中执行更深的官方 generator differential tests；
