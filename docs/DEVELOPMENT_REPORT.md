...
│   └── file-based generator, Schema Doctor, compatibility checks, AI verify, official differential, descriptor reports and registry manifests
├── tests/oracle/
...
- Schema Doctor、AI verify report、official differential report、descriptor verify/compat/registry report 与 CI 官方源码契约检查通过；
...
- `docs/SCHEMA_REGISTRY.md` descriptor registry workflow 说明；
