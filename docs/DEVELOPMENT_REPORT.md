...
- protobuf-style JSON writer/parser，覆盖 bytes base64、64-bit integer string form、repeated/map/nested/oneof 与 `null`-as-absent 解析语义；
