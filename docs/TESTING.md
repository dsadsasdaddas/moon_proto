...
- JSON parser roundtrip, `null`-as-absent parsing, lowerCamelCase field-name aliases, canonical duplicate-key rejection and repeated-element null rejection;
