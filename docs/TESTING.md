...
- parser tolerance for dotted package/type names, import, option, reserved/extensions, field/enum options, nested message/enum definitions, block comments, and ignored service/rpc blocks;
