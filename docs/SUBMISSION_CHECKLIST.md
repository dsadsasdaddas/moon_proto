...
| 项目规模 4k+ MoonBit LOC | 当前 MoonBit 源码约 `7167` 行 |
| 清晰工程结构 | wire/schema/runtime/json/codegen/cli/tests/docs 分层 |
| 示例 schema | `examples/simple/user.proto`、`examples/decorated/telemetry.proto`、`examples/decorated/telemetry_service.proto`、`examples/decorated/nested_types.proto`、`examples/decorated/nested_qualified.proto`、`examples/decorated/enum_numbers.proto`、`examples/decorated/enum_alias.proto`、`examples/decorated/string_literals.proto` |
...
| MoonBit tests | `moon test`，当前 `51/51 passed` |
