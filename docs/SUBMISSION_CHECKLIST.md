...
- FileDescriptorSet descriptor/reflection bridge、descriptor verify report、old/new descriptor compatibility report、descriptor registry release gate、JSON release-policy DSL/warning check、file/HTTP registry adapter publish/pull 与 JUnit XML CI report；
