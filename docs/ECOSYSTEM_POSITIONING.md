...
5. **Future integration path**
   ...
   - use `scripts/moon_proto_descriptor.py` to import FileDescriptorSet/reflection data from existing protobuf pipelines, compare old/new descriptors before rollout, and build a small descriptor registry release gate with JSON release policies;
