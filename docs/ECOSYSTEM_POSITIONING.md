...
5. **Future integration path**
   ...
   - use `scripts/moon_proto_descriptor.py` to import FileDescriptorSet/reflection data from existing protobuf pipelines and compare old/new descriptors before rollout;
